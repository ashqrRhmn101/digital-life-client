...
const AddLesson = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 py-12 px-4">
      <div data-aos="fade-up" className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 border border-amber-200 dark:border-amber-800">
        <h2 data-aos="zoom-in" className="text-4xl font-bold text-center bg-gradient-to-r from-amber-600 to-amber-400 bg-clip-text text-transparent mb-8">
          Add New Life Lesson
        </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div data-aos="fade-left" data-aos-delay="400">
            ...
            {errors.emotionalTone && <p className="text-red-500 text-sm">{errors.emotionalTone.message}</p>}
          </div>

          {/* Image Upload */}
          <div data-aos="fade-right" data-aos-delay="500">
            <label className="label font-medium">Featured Image (Optional)</label>
            <input
              type="file"
              accept="image/*"
              {...register("image")}
          ...
          <div data-aos="fade-right" data-aos-delay="700">
            ...
            <Tippy content={!isPremium ? "Upgrade to Premium to create premium lessons" : ""}>
              <select
                {...register("accessLevel", { required: "Access level is required" })}
                disabled={!isPremium}
                className={`select select-bordered w-full ${!isPremium ? "select-disabled cursor-not-allowed" : ""}`}
              >
                <option>Free</option>
